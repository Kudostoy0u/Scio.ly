...
export default function AboutClientPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden">
      <div className={`fixed inset-0 ${darkMode ? 'bg-gray-900' : 'bg-gray-50'}`}></div>
      <Header />
      <main className="relative z-10 pt-36 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              <div className={`${darkMode ? 'bg-gray-700/50' : 'bg-gray-100/50'} p-4 rounded-lg text-center`}>
                <div className="flex justify-center mb-3">
                  <Image src="/about/file.svg" alt="PDF Files" width={50} height={50} className="filter invert" />
                </div>
                <h3 className={`font-semibold mb-2 ${darkMode ? 'text-white' : 'text-gray-900'}`}>PDF Processing</h3>
                <p className={`${darkMode ? 'text-gray-300' : 'text-gray-600'} text-sm`}>Extract questions from tournament archives</p>
              </div>
              <div className={`${darkMode ? 'bg-gray-700/50' : 'bg-gray-100/50'} p-4 rounded-lg text-center`}>
                <div className="flex justify-center mb-3">
                  <Image src="/about/google-icon.png" alt="Google Gemini 2.5" width={50} height={50} />
                </div>
                <h3 className={`font-semibold mb-2 ${darkMode ? 'text-white' : 'text-gray-900'}`}>Gemini 2.5 AI</h3>
                <p className={`${darkMode ? 'text-gray-300' : 'text-gray-600'} text-sm`}>Advanced AI processing & answer generation</p>
              </div>
              <div className={`${darkMode ? 'bg-gray-700/50' : 'bg-gray-100/50'} p-4 rounded-lg text-center`}>
                <div className="flex justify-center mb-3 space-x-2">
                  <Image src={darkMode ? "/about/cog-white.png" : "/about/cog-black.png"} alt="Processing" width={40} height={40} />
                  <Image src="/about/postgresql-icon.png" alt="PostgreSQL" width={40} height={40} />
                </div>
                <h3 className={`font-semibold mb-2 ${darkMode ? 'text-white' : 'text-gray-900'}`}>Processing & Storage</h3>
                <p className={`${darkMode ? 'text-gray-300' : 'text-gray-600'} text-sm`}>Filter, validate & store in PostgreSQL</p>
              </div>
              <div className={`${darkMode ? 'bg-gray-700/50' : 'bg-gray-100/50'} p-4 rounded-lg text-center`}>
                <div className="flex justify-center mb-3 space-x-2">
                  <Image src={darkMode ? "/about/vercel-white.png" : "/about/vercel-icon.svg"} alt="Vercel" width={35} height={35} />
                  <Image src={darkMode ? "/about/nextjs-white.png" : "/about/nextjs-black.png"} alt="Next.js Frontend" width={35} height={35} />
                </div>
                <h3 className={`font-semibold mb-2 ${darkMode ? 'text-white' : 'text-gray-900'}`}>Deployment & Frontend</h3>
        ...
        <section className={`mb-16 p-6 rounded-xl max-w-4xl mx-auto ${darkMode ? 'bg-gray-800/50 backdrop-blur-sm' : 'bg-white/90 shadow-lg backdrop-blur-sm'}`}>
          <h2 className={`text-3xl font-bold mb-6 text-center ${darkMode ? 'text-white' : 'text-gray-900'}`}>Our Philosophy</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h3 className={`text-xl font-semibold mb-2 ${darkMode ? 'text-white' : 'text-gray-900'}`}>Learn by Doing</h3>
            ...
            <div>
              <h3 className={`text-xl font-semibold mb-2 ${darkMode ? 'text-white' : 'text-gray-900'}`}>Accessibility for All</h3>
              <p className={`${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>
        ...
        <section className={`mb-16 p-6 rounded-xl text-center max-w-4xl mx-auto ${darkMode ? 'bg-gray-800/50 backdrop-blur-sm' : 'bg-white/90 shadow-lg backdrop-blur-sm'}`}>
          <h2 className={`text-2xl font-bold mb-4 ${darkMode ? 'text-white' : 'text-gray-900'}`}>Want to get in touch?</h2>
