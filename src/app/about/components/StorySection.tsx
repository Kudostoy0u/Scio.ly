	...
	return (
		<div className="flex flex-col md:flex-row items-center gap-8">
			<div className="md:w-1/2">
				...
				<div
					className={`${darkMode ? "text-gray-300" : "text-gray-700"} space-y-4`}
				>
					<p>
						Hey! We&apos;re Aiden and Kundan. We experienced firsthand the
						challenge of finding high-quality, centralized practice materials
						for Science Olympiad. After spent countless hours searching for past
						tests, we decided to build the platform we wished we had: a
						comprehensive, accessible, and user-friendly test-taking platform
						that would empower students to excel.
					</p>
				</div>
			</div>
