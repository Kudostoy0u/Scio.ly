		...
		<div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-stretch">
			...
			>
				...
				<p className={`${darkMode ? "text-gray-200" : "text-gray-800"}`}>
					<span className="font-semibold">Thanks to Steven</span> for coming up
					with the idea for Scio.ly and helping us start it!
				</p>
			</div>
			<div
				className={`${darkMode ? "bg-gray-700/50" : "bg-gray-100/60"} p-5 rounded-lg flex items-start gap-4`}
			>
				...
				<p className={`${darkMode ? "text-gray-200" : "text-gray-800"}`}>
					...
					<span className="font-semibold">1.1K tournaments</span> for our
					questions database!
				</p>
			</div>
		</div>
