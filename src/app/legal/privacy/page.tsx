		...
		<ThemeSection className="min-h-screen">
			...
			<main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16">
				...
				<div className="prose prose-lg prose-slate max-w-none dark:prose-invert dark:prose-headings:text-gray-100 dark:prose-p:text-gray-300 dark:prose-li:text-gray-300 dark:prose-strong:text-gray-100">
					...
					<p>
						Welcome to Scio.ly. We are committed to protecting your privacy.
					...
					<p>
						...
						email address, and school information when you register for an
						account. We also collect non-personal information, such as browser
						type, operating system, and usage details.
					</p>
					<h2 className="text-2xl font-semibold mt-8 mb-4">
					...
					<ul>
						...
						<li>
							Communicate with you, including updates and other information
					...
					<p>
						...
						advance notice. This does not include hosting partners and other
					...
					<p>
						...
						help protect your personal information. Despite our efforts, no
					...
					<p>
						...
						us at team.scio.ly@gmail.com or our Contact form.
					</p>
				</div>
			</main>
		</ThemeSection>
