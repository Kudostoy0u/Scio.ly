    ...
    <div className={`${darkMode ? 'bg-gray-900 text-white' : 'bg-white text-gray-900'} min-h-screen`}>
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <p>
            By accessing and using Scio.ly (the &quot;Service&quot;), you agree to be bound by these Terms of Service (&quot;Terms&quot;). 
            If you do not agree to these Terms, please do not use the Service.
          </p>

          <h2 className="text-2xl font-semibold mt-8 mb-4">2. Description of Service</h2>
          <p>
            Scio.ly is a platform that provides practice questions, AI-powered explanations, and other tools for Science Olympiad preparation. 
            The Service is provided &quot;as is&quot; and is constantly under development.
          </p>
