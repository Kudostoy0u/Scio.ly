    ...
    <ThemeSection className="min-h-screen">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16">
        ...
        <div className="prose prose-lg prose-slate max-w-none dark:prose-invert dark:prose-headings:text-gray-100 dark:prose-p:text-gray-300 dark:prose-li:text-gray-300 dark:prose-strong:text-gray-100">
          ...
          <p>
            By accessing and using Scio.ly (the &quot;Service&quot;), you agree to be bound by these
            Terms of Service (&quot;Terms&quot;). If you do not agree to these Terms, please do not
            use the Service.
          </p>
          <h2 className="text-2xl font-semibold mt-8 mb-4">2. Description of Service</h2>
          <p>
            Scio.ly is a platform that provides practice questions, AI-powered explanations, and
            other tools for Science Olympiad preparation. The Service is provided &quot;as is&quot;
          ...
          <p>
            ...
            the exclusive property of Scio.ly and its licensors.
          </p>
          ...
          <p>
            ...
            Scio.ly does not warrant that the Service will be uninterrupted, secure, or error-free.
          </p>
          <h2 className="text-2xl font-semibold mt-8 mb-4">6. Limitation of Liability</h2>
          <p>
            In no event shall Scio.ly, nor its directors, employees, partners, agents, suppliers, or
