		...
		<ThemeSection className="min-h-screen">
			...
			<main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16">
				...
				<div className="prose prose-lg prose-slate max-w-none dark:prose-invert dark:prose-headings:text-gray-100 dark:prose-p:text-gray-300 dark:prose-li:text-gray-300 dark:prose-strong:text-gray-100">
					...
					<p>
						By accessing and using Scio.ly (the &quot;Service&quot;), you agree
					...
					<p>
						Scio.ly is a platform that provides practice questions, AI-powered
						explanations, and other tools for Science Olympiad preparation. The
						Service is provided &quot;as is&quot; and is constantly under
						development.
					</p>
					...
					<p>
						...
						are and will remain the exclusive property of Scio.ly and its
						licensors.
					</p>
					<h2 className="text-2xl font-semibold mt-8 mb-4">
					...
					<p>
						...
						express or implied. Scio.ly does not warrant that the Service will
					...
					<p>
						In no event shall Scio.ly, nor its directors, employees, partners,
