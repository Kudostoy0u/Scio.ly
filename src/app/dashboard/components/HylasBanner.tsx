...
// 		<div
// 			className={
// 				"fixed top-0 left-0 right-0 z-40 shadow-lg transition-colors duration-300"
// 			}
...
// 					<div
// 						className={`text-xs sm:text-sm text-center ${darkMode ? "text-gray-300" : "text-gray-700"}`}
// 					>
...
// 								<ExternalLink className="inline w-3 h-3 ml-1" />
// 							</a>
// 							, a satellite tournament hosted by part of our team @ Los Altos
// 							High School, CA!
// 						</span>
// 					</div>
// 				</div>
