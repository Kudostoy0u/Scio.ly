			...
			<main className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pt-20">
				<div className="mb-8 mt-8">
					<div className="flex items-center justify-between">
						...
						<button
							type="button"
							onClick={() => {
								const testConfigSection =
									document.querySelector("[data-test-config]");
					...
					<p className={`mt-2 ${darkMode ? "text-gray-400" : "text-gray-600"}`}>
						Select an event from the 2026 events list and configure your
						practice session
					</p>
				</div>
				...
				<div className="flex flex-col lg:flex-row gap-8 items-stretch">
					...
					<div
						...
						style={{
							height: isLarge && panelHeight ? `${panelHeight}px` : "48vh",
						}}
					>
						<EventList
							events={events}
