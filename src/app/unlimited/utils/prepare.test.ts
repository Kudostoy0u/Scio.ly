...
describe('prepareUnlimitedQuestions', () => {
  it('returns only placeholders when pct is 100', () => {
    ...
    const out = prepareUnlimitedQuestions({ baseQuestions: base, eventName: 'Rocks and Minerals', idPercentage: 100 });
  ...
  it('splits base and id placeholders according to percentage', () => {
    ...
    const out = prepareUnlimitedQuestions({ baseQuestions: base, eventName: 'Rocks and Minerals', idPercentage: 50 });
  ...
  it('handles invalid percentage values safely', () => {
    const base = Array.from({ length: 10 }, (_, i) => makeQ(i));
    const out = prepareUnlimitedQuestions({ baseQuestions: base, idPercentage: 'not-a-number' as any });
