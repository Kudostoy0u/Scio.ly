		...
		[
			...
			<div key="chemistry-dropdown" className="relative">
				<details className="cursor-pointer">
					...
					>
						<div
							className={`space-y-1 text-xs ${darkMode ? "text-gray-300" : "text-gray-700"}`}
						>
...
const SecondDivisionSubtopicTable = ({
	darkMode,
}: DivisionSubtopicTableProps) => {
				...
				>
					...
					<div className="mb-12">
						...
						>
							...
							, only choose divisions or subtopics that have green cells (or
							else the bot will choose randomly for you).
						</p>
					...
					{/* Credits */}
					<div
						className={`border-t pt-8 ${darkMode ? "border-gray-600" : "border-gray-300"}`}
					>
						<h2
							className={`text-2xl font-bold mb-6 ${darkMode ? "text-white" : "text-gray-900"}`}
						>
						...
						>
							...
							<p>
								Special thanks to Alan (Discord: alaninnovates) for helping to
								set up the bot.
							</p>
						</div>
					</div>
