...
describe('/api/teams/[teamId]/roster/invite', () => {
  ...
  describe('GET', () => {
    it('should search users successfully', async () => {
      ...
      const request = new NextRequest('http://localhost:3000/api/teams/test-team/roster/invite?q=user');
    ...
    it('should return empty array for short queries', async () => {
      const request = new NextRequest('http://localhost:3000/api/teams/test-team/roster/invite?q=a');
