...
const ANATOMY_EVENTS = ["Anatomy - Endocrine", "Anatomy - Nervous", "Anatomy - Sense Organs"];

export function resolveEventName(eventName: string): { eventName: string; targetEvents: string[] } {
