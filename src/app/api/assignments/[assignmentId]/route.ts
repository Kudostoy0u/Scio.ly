...
export async function GET(
  ...
  try {
    ...
    const assignment: AssignmentRow = {
      ...
      createdAt: assignmentRow.createdAt ? String(assignmentRow.createdAt) : new Date().toISOString(),
      updatedAt: assignmentRow.updatedAt ? String(assignmentRow.updatedAt) : new Date().toISOString(),
