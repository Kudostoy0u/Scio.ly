              ...
              >
                <Link href="/dashboard">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className={`group flex items-center gap-2 px-8 py-4 rounded-lg font-semibold text-lg transition-all ${
                      darkMode
            ...
            >
              <div className="relative">
                ...
                <motion.div
                  ...
                  className={`absolute -top-4 -left-4 p-4 rounded-xl shadow-lg ${darkMode ? 'bg-gray-800 border border-gray-700' : 'bg-white border border-gray-200'}`}
                >
                ...
                <motion.div
                  ...
                  className={`absolute -bottom-4 -right-4 p-4 rounded-xl shadow-lg ${darkMode ? 'bg-gray-800 border border-gray-700' : 'bg-white border border-gray-200'}`}
                >
                  <div className="text-center">
            ...
            <div className="embla__container">
              ...
              <div className="embla__slide p-4">
                <div className={`p-8 rounded-2xl border h-[300px] flex flex-col items-center text-center ${darkMode ? 'bg-gray-800/50 border-gray-700/50' : 'bg-white border-gray-200 shadow-lg'}`}>
                  ...
                  <p className={`${darkMode ? 'text-gray-400' : 'text-gray-600'} flex-grow`}>We&apos;ve aquired over a thousand tournaments worth of questions for use on this platform - much more than is publicly available </p>
                </div>
              </div>
              {/* Feature 2 */}
              <div className="embla__slide p-4">
