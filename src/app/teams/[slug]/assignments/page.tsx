...
import TeamAssignmentsClient from "./TeamAssignmentsClient";

export default async function TeamAssignmentsPage(ctx: { params: Promise<{ slug: string }> }) {
