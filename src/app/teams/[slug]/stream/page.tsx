import TeamStreamClient from './TeamStreamClient';
...
export default async function TeamStreamPage(ctx: { params: Promise<{ slug: string }> }) {
  ...
  try {
    ...
    console.error('Error loading team stream:', error);
