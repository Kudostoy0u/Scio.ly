...
import { Conflict } from './rosterUtils';
      ...
      <div className="flex items-center space-x-2">
        ...
        {conflicts.length > 0 && (
          <div className="relative group">
            ...
            <div className={`absolute left-full top-1/2 transform -translate-y-1/2 ml-2 px-3 py-2 rounded-lg shadow-lg text-sm whitespace-nowrap z-50 opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none ${
            ...
            <div className={`absolute top-full left-1/2 transform -translate-x-1/2 mt-2 px-3 py-2 rounded-lg shadow-lg text-sm whitespace-nowrap z-50 opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none ${
              darkMode ? 'bg-gray-800 text-white border border-gray-600' : 'bg-white text-gray-900 border border-gray-200'
            } md:hidden`}>
              <div className="font-medium mb-1">Conflict Detected:</div>
              {conflicts.map((conflict, index) => (
