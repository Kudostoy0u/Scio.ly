				...
				return (
					<div key={uniqueKey} className="relative">
							...
							<div className="flex items-start justify-between">
								<div className="flex-1">
									<div className="flex items-center gap-3 mb-2">
										...
										<span
											className={getEventTypeBadgeClasses(event.event_type)}
										>
						...
						<button
							...
							className={`absolute top-2 right-2 p-2 rounded-full transition-colors cursor-pointer ${darkMode ? "text-red-400 hover:bg-red-900/30 hover:text-red-300" : "text-red-500 hover:bg-red-100 hover:text-red-700"}`}
							title="Delete event"
