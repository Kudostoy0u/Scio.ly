      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              onSettingsChange({ questionCount: Number.parseInt(e.target.value) || 0 })
            }
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  if (value === "mcq" || value === "frq" || value === "both") {
                    onSettingsChange({ questionType: value as "mcq" | "frq" | "both" });
                  }
                }}
                className="mr-2"
              />
        ...
        <div>
          ...
          <div className="flex items-center gap-3">
            <input
              ...
              onChange={(e) => onSettingsChange({ idPercentage: Number.parseInt(e.target.value) })}
              className="flex-1"
            />
