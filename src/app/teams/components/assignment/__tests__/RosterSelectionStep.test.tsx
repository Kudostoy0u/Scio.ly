...
import RosterSelectionStep from '../RosterSelectionStep';
import { RosterMember } from '../assignmentTypes';
...
describe('RosterSelectionStep', () => {
  ...
  describe('Empty State', () => {
    it('shows empty state when no roster members', () => {
      ...
      expect(screen.getByText('Make sure team members are properly linked to their accounts.')).toBeInTheDocument();
    });
  });
  ...
  describe('Member Selection', () => {
    ...
    it('adds multiple members to selection', () => {
      ...
      expect(mockProps.onRosterChange).toHaveBeenCalledWith(['John Doe', 'Jane Smith']);
    });
  });
