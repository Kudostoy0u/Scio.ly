              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleSettingsChange({ questionCount: Number.parseInt(e.target.value) || 0 })
                    }
                    className={`mt-1 block w-full rounded-md border px-3 py-2 ${
                      darkMode
                        ? "border-gray-600 bg-gray-700 text-white"
                              ...
                              onClick={() => {
                                ...
                                if (currentTypes.includes("all")) {
                                  ...
                                  handleSettingsChange({
                                    cipherTypes: newTypes.length > 0 ? newTypes : ["all"],
                                  });
                                } else {
                                  // Add this cipher
                                  handleSettingsChange({
                                    cipherTypes: [...currentTypes, cipherType],
                                  });
                                }
                      ...
                      onClick={() => {
                        if (selectedRoster.includes(member.student_name)) {
                          setSelectedRoster((prev) =>
                            prev.filter((name) => name !== member.student_name)
                          );
                        } else {
