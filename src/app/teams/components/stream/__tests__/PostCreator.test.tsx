...
describe("PostCreator", () => {
	...
	describe("Rendering", () => {
		it("renders post creation form", () => {
			...
			expect(
				screen.getByPlaceholderText("What's happening with the team?"),
			).toBeInTheDocument();
	...
	describe("Content Display", () => {
		it("displays current content in textarea", () => {
			render(
				<PostCreator {...defaultProps} newPostContent="Existing content" />,
			);
		...
		it("updates textarea when content prop changes", () => {
			...
			rerender(
				<PostCreator {...defaultProps} newPostContent="Updated content" />,
			);
