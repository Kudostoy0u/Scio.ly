...
const createMockResponse = (data: any, status = 200) => new Response(JSON.stringify(data), { status });
...
describe('AssignmentViewer', () => {
  ...
  it('should handle codebusters questions', () => {
    ...
    expect(screen.getByPlaceholderText('Enter your codebusters answer here...')).toBeInTheDocument();
  });
