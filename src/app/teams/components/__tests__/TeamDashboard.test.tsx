...
describe('TeamDashboard', () => {
  ...
  it.skip('should search users when typing in invite modal', async () => {
    // This test is skipped because the current BannerInvite component doesn't have search functionality
  });

  // Search functionality not implemented in current BannerInvite component
  it.skip('should show search results in invite modal', async () => {
    // This test is skipped because the current BannerInvite component doesn't have search functionality
  });

  // Search functionality not implemented in current BannerInvite component
  it.skip('should select user when clicked in search results', async () => {
    // This test is skipped because the current BannerInvite component doesn't have search functionality
  });

  // Search functionality not implemented in current BannerInvite component
  it.skip('should send invitation when send button is clicked', async () => {
    const mockUsers = [
      {
        id: 'user-456',
