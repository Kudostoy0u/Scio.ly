...
export default function TabNavigation({ teamSlug }: TabNavigationProps) {
  ...
  const tabs = [
    ...
    { id: 'assignments', label: 'Assignments', icon: ClipboardList, href: `/teams/${teamSlug}/assignments` },
  ...
  return (
    <>
      ...
      <div className={`hidden md:block sticky top-0 z-20 border-b ${darkMode ? 'border-gray-700 bg-gray-900' : 'border-gray-200 bg-white'}`}>
      ...
      <div className={`md:hidden fixed bottom-0 left-0 right-0 z-40 ${darkMode ? 'bg-gray-800 border-t border-gray-700' : 'bg-white border-t border-gray-200'}`}>
