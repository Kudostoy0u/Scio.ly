          ...
          <form onSubmit={handleSubmit} className="px-6 py-4">
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <School className={`h-5 w-5 ${darkMode ? "text-gray-500" : "text-gray-400"}`} />
                  </div>
                  <input
                    id="school"
                    type="text"
              ...
              <div>
                ...
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <Trophy className={`h-5 w-5 ${darkMode ? "text-gray-500" : "text-gray-400"}`} />
                  </div>
                  <select
                    id="division"
                    required={true}
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, division: e.target.value as "B" | "C" })
                    }
                    className={`block w-full pl-10 pr-3 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${
                      darkMode
