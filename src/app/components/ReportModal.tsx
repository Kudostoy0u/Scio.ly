...
const ReportModal = ({ isOpen, onClose, onSubmit, darkMode, question, event }: ReportModalProps) => {
  ...
  return (
    <>
      ...
      >
        <div 
          className={`rounded-lg p-6 w-[90%] sm:w-[800px] max-h-[90vh] overflow-y-auto mx-4  ${
        ...
        >
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex justify-end space-x-2">
              ...
              <button
                type="submit"
                className="px-4 py-2 rounded-md bg-red-500 text-white hover:bg-red-600  flex items-center space-x-2"
                disabled={isProcessing}
              >
                {isProcessing ? (
                  <>
