...
export function DesktopNavLinks({ darkMode, pathname }: { darkMode: boolean; pathname: string }) {
...
export function MobileNavLinks({
  ...
  return (
    <>
      <Link href="/practice" className={mobileLinkStyles("/practice")} onClick={onClose}>
        Practice
      </Link>
      <Link href="/dashboard" className={mobileLinkStyles("/dashboard")} onClick={onClose}>
        Dashboard
      </Link>
      <Link href="/teams" className={mobileLinkStyles("/teams")} onClick={onClose}>
        Teams
      </Link>
      <Link href="/analytics" className={mobileLinkStyles("/analytics")} onClick={onClose}>
        Analytics
      </Link>
    </>
  );
...
export function MobileMoreSection({
  ...
  return (
    <div className="pt-2 pb-1">
      ...
      <Link href="/join" className={mobileLinkStyles("/join")} onClick={onClose}>
        Join Us
      </Link>
      <Link href="/contact" className={mobileLinkStyles("/contact")} onClick={onClose}>
        Contact Us
      </Link>
      <Link href="/about" className={mobileLinkStyles("/about")} onClick={onClose}>
        About Us
      </Link>
    </div>
  );
