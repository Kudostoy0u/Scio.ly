...
export function computeBackgroundColor(darkMode: boolean, opacity: number): string {
  if (darkMode) {
...
export function shouldShowBlur(isHomePage: boolean, isTestPage: boolean, opacity: number): boolean {
