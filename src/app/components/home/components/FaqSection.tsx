...
const faqs = [
	{
		...
		answer: (
			<>
				Our questions are sourced from real Science Olympiad tests and
				resources, ensuring a comprehensive and diverse question bank. We only
				use{" "}
				<Link
					href="/certified"
	...
	},
	{
		...
		answer:
			"Scio.ly is an initiative in partnership with SoCal Science Olympiad, but it is not endorsed by Science Olympiad Inc. Our platform provides practice materials based on past exams but we do not make any guarantees about content on future exams.",
	},
	{
		id: "faq-contribute",
