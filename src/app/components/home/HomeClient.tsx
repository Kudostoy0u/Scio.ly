            ...
            <div className="embla__container">
              ...
              <div className="embla__slide p-4">
                ...
                >
                  ...
                  <p className={`${darkMode ? "text-gray-400" : "text-gray-600"} flex-grow`}>
                    We&apos;ve acquired over a thousand tournaments worth of questions for use on
                    this platform - much more than is publicly available
                  </p>
                </div>
              </div>
              {/* Feature 2 */}
              <div className="embla__slide p-4">
                ...
                >
                  ...
                  <p className={`${darkMode ? "text-gray-400" : "text-gray-600"} flex-grow`}>
                    Get instant, detailed explanations for every question using Google&apos;s Gemini
                    2.5 models
                  </p>
                </div>
              </div>
              ...
              <div className="embla__slide p-4">
                ...
                >
                  ...
                  <p className={`${darkMode ? "text-gray-400" : "text-gray-600"} flex-grow`}>
                    Track your progress - weekly, daily, or all-time. See how you&apos;ve improved,
                    and bookmark questions to come back to
                  </p>
                </div>
              </div>
              {/* Feature 4 */}
              <div className="embla__slide p-4">
                ...
                >
                  ...
                  <p className={`${darkMode ? "text-gray-400" : "text-gray-600"} flex-grow`}>
                    Choose how you want to practice. Take a timed test similar to game day, or
                    choose unlimited practice for an addictive experience
                  </p>
                </div>
              </div>
              {/* Feature 5 */}
              <div className="embla__slide p-4">
                ...
                >
                  ...
                  <p className={`${darkMode ? "text-gray-400" : "text-gray-600"} flex-grow`}>
                    Share tests with teammates using unique codes. Collaborate and study together,
            ...
            {[...new Array(4)].map((_, index) => (
              ...
              >
                ...
                <p className={darkMode ? "text-gray-300" : "text-gray-600"}>
                  {index === 0 ? (
                    <>
                      Our questions are sourced from real Science Olympiad tests and resources,
                      ensuring a comprehensive and diverse question bank. We only use{" "}
                      <Link
                        href="/certified"
