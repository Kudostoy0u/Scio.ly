...
export default function SummaryGrid({ items, darkMode, showCompactLayout, className = '' }: SummaryGridProps) {
  ...
  return (
    <div className={`grid gap-3 transition-all duration-500 ease-in-out md:transition-none ${
      showCompactLayout
      ...
      <div className={`${cardBase} ${cardPadding} relative`}>
        {items[0]?.icon && (
          <div className={`absolute left-2 top-1/2 -translate-y-1/2 transition-opacity duration-300 md:transition-none ${showCompactLayout ? 'opacity-100' : 'opacity-0 md:opacity-0'}`}>
        ...
        <div className={`${labelClass} transition-all duration-300 md:transition-none overflow-hidden ${showCompactLayout ? 'max-h-0 opacity-0 md:max-h-6 md:opacity-100' : 'max-h-6 opacity-100'}`}>{items[0]?.label}</div>
      </div>
      ...
      <div className={`${cardBase} ${cardPadding} relative`}>
        ...
        <div className={`${labelClass} transition-all duration-300 md:transition-none overflow-hidden ${showCompactLayout ? 'max-h-0 opacity-0 md:max-h-6 md:opacity-100' : 'max-h-6 opacity-100'}`}>{items[1]?.label}</div>
      </div>
      ...
      <div className={`${cardBase} ${cardPadding} relative`}>
        ...
        <div className={`${labelClass} transition-all duration-300 md:transition-none overflow-hidden ${showCompactLayout ? 'max-h-0 opacity-0 md:max-h-6 md:opacity-100' : 'max-h-6 opacity-100'}`}>{items[2]?.label}</div>
      </div>
      ...
      <div className={`${cardBase} ${cardPadding} relative`}>
        ...
        <div className={`${labelClass} transition-all duration-300 md:transition-none overflow-hidden ${showCompactLayout ? 'max-h-0 opacity-0 md:max-h-6 md:opacity-100' : 'max-h-6 opacity-100'}`}>{items[3]?.label}</div>
      </div>
    </div>
  );
}
