import { getCorrectLetterDisplay, getTokenInputClassName } from "../utils/displayHelpers";
...
export const TokenInput = ({
  ...
  return (
    ...
    >
      ...
      />
      {isTestSubmitted && (
        <div className={`mt-1 text-[10px] ${correctDisplay.className}`}>{correctDisplay.text}</div>
      )}
    </div>
  );
};
