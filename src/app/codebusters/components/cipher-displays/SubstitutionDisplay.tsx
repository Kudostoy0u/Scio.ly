              ...
              {isLetter && (
                <div className="relative h-12 sm:h-14">
                  <input
                    ...
                    disabled={isTestSubmitted}
                    onChange={(e) =>
                      handleSolutionChangeWithValidation(char, e.target.value.toUpperCase())
                    }
      ...
      {isTestSubmitted && (
        <div className={`mt-8 p-4 rounded ${darkMode ? "bg-gray-700/50" : "bg-gray-50"}`}>
          ...
          {quotes[quoteIndex]?.key && (
            <div className="mt-3">
              <p className={`text-sm mb-1 ${darkMode ? "text-gray-300" : "text-gray-600"}`}>Keyword:</p>
            ...
            <div className="mt-3 grid grid-cols-1 sm:grid-cols-2 gap-3">
              {quotes[quoteIndex]?.plainAlphabet && (
                <div>
                  ...
                  <p
                    className={`font-mono text-xs break-all ${darkMode ? "text-gray-200" : "text-gray-800"}`}
                  >
                    {quotes[quoteIndex].plainAlphabet}
                  </p>
                </div>
