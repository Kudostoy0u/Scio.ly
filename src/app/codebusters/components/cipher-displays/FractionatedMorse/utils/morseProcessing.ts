...
function processMorseCharacter(
	...
	const newMorseStartIndex =
		currentMorse.length === 0 ? currentIndex : morseStartIndex;
	return {
...
function processXCharacter(
	...
	const doubleXResult = handleDoubleXSeparator(
		i,
		morseString,
		currentIndex,
		plaintextLetters,
