...
export const CheckerboardDisplay = ({
  ...
  const syncGridFromSolutions = createSyncGridFromSolutions(tokens, solution, setGridValues);
  const applyTokenToGrid = createApplyTokenToGridHandler(colLabels, rowLabels, setGridValues);
  ...
  const handleColLabelKeyDown = createColLabelKeyDownHandler(colLabels, setColLabels);
  const handleRowLabelKeyDown = createRowLabelKeyDownHandler(rowLabels, setRowLabels);
  ...
  const handleGridCellKeyDown = createGridCellKeyDownHandler(gridValues, setGridValues);
