...
export const gradeHill2x2 = (quote: QuoteData, questionPointValue: number): GradingResult => {
...
export const gradeHill3x3 = (quote: QuoteData, questionPointValue: number): GradingResult => {
  const expectedPlaintext = quote.quote.toUpperCase().replace(/[^A-Z]/g, "");
