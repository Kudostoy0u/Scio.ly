...
export const getPlainLetterCaesar = (
	quote: QuoteData,
	randomCipherLetter: string,
): string => {
...
export const getPlainLetterAffine = (
	quote: QuoteData,
	randomCipherLetter: string,
): string => {
	if (
...
export const getPlainLetterFromKey = (
	quote: QuoteData,
	randomCipherLetter: string,
): string => {
	if (!quote.key) {
...
export const getPlainLetterByPosition = (
	quote: QuoteData,
	randomCipherLetter: string,
): string => {
...
export const getPlainLetterXenocrypt = (
	quote: QuoteData,
	randomCipherLetter: string,
): string => {
...
export const getPlainLetterHill = (
	quote: QuoteData,
	randomCipherLetter: string,
): string => {
	if (
...
export const getPlainLetterForCipher = (
	quote: QuoteData,
	randomCipherLetter: string,
): string => {
	const handlers = [
		...
		() =>
			quote.cipherType === "Atbash"
				? getPlainLetterAtbash(randomCipherLetter)
				: "",
