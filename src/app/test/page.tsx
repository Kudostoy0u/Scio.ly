...
export const metadata: Metadata = {
	title: "Scio.ly | Test",
	description:
		"Take a Science Olympiad test from tens of thousands of available questions",
};
...
export default async function Page({
	...
	const difficulties = Array.isArray(parsed?.difficulties)
		...
		: undefined;
	const idPercentage =
		typeof parsed?.idPercentage !== "undefined"
	...
	return (
		<Content initialData={initialData} initialRouterData={finalRouterData} />
	);
}
