...
export interface QuestionHandlersCallbacks {
  ...
  setUserAnswers: React.Dispatch<React.SetStateAction<Record<number, (string | null)[] | null>>>;
  ...
  setSubmittedReports: React.Dispatch<React.SetStateAction<Record<number, boolean>>>;
  setSubmittedEdits: React.Dispatch<React.SetStateAction<Record<number, boolean>>>;
}
