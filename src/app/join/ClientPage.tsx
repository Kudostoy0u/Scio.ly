...
import { Briefcase, Clock, GraduationCap, Mail, MessageCircle, Send, User } from "lucide-react";
        ...
        <div className="max-w-2xl mx-auto">
          <div className="mb-8">
            ...
            <p className={`${darkMode ? "text-gray-400" : "text-gray-600"}`}>
              Become a Scio.ly developer! Join a team of highly motivated high school and college
              students working on a site that thousands of competitors use every day.{" "}
              <span className="font-semibold">Better Science Olympiad practice, for everyone.</span>
            </p>
          </div>
          <div
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <p className={`text-xs mt-1 ${darkMode ? "text-gray-500" : "text-gray-400"}`}>
                  All communication happens through Discord
                </p>
              </div>
              <div>
                <label
              ...
              <div>
                ...
                <div className="flex justify-between items-center mt-1">
                  <p className={`text-xs ${darkMode ? "text-gray-500" : "text-gray-400"}`}>
                    We&apos;re looking for people ready to hustle! If you have any, link relevant
                    projects, Instagram accounts if you want to market, GitHub if you want to write
                    code, etc.
                  </p>
                  <span
              ...
              <div>
                ...
                <div className="flex justify-between items-center mt-1">
                  <p className={`text-xs ${darkMode ? "text-gray-500" : "text-gray-400"}`}>
                    Yes, it&apos;s a resume line. But what else interests you about a position with
                    Scio.ly?
                  </p>
                  <span
