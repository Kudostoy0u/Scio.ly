        ...
        <section>
          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-1">
              ...
              <div>
                <span className={darkMode ? "text-gray-400" : "text-gray-600"}>Participants:</span>{" "}
                <span className={darkMode ? "text-gray-100" : "text-gray-900"}>
                  {meta.participants}
                </span>
              </div>
              ...
              {hasGoogleNotesheet && googleNotesheetLink ? (
                ...
                <button
                  ...
                  onClick={() => {
                    toast.info(
                      <div>
                        A notesheet is not available for this event (yet). If you have notesheets
                        for this season, please help us out and send it through{" "}
                        <a
