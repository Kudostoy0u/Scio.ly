    ...
    <div className="pt-24 pb-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between mb-4">
          <h1 className={`text-2xl font-semibold ${darkMode ? 'text-gray-100' : 'text-gray-900'}`}>Edit Docs – {evt.name}</h1>
          <div className="flex gap-2">
            ...
            <button className={`px-3 py-1 rounded border ${darkMode ? 'border-gray-700 text-gray-100' : 'border-gray-300 text-gray-900'}`} onClick={()=>router.push(`/docs/${evt.slug}`)}>Back</button>
          </div>
        </div>
