...
describe("eventUtils", () => {
  ...
  describe("getPrimaryBadgeForEvent", () => {
    ...
    it("returns notesheet badge for events with notesheet allowed", () => {
      const notesheetEvent = { ...baseEvent, notesheetAllowed: true };
    ...
    it("returns binder badge for binder events", () => {
      ...
      const binderEvent = { ...baseEvent, name: binderEventName };
    ...
    it("returns misc badge for misc events", () => {
      ...
      const miscEvent = { ...baseEvent, name: miscEventName };
  ...
  describe("getEventBySlug", () => {
    const slugToEvent: Record<string, DocsEvent> = {
      ...
      "another-event": { ...baseEvent, slug: "another-event", name: "Another Event" },
    };
