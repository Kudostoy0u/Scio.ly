...
const details: Record<string, Partial<DocsEvent>> = {
  ...
  Boomilever: {
    eventType: "build",
    overview: "Students will design and build a wooden structure to hold weight.",
  },
  "Bungee Drop": {
    eventType: "build",
  ...
  "Electric Vehicle": {
    eventType: "build",
    overview: "Students will design and build a vehicle that travels a specific distance.",
  },
  Helicopter: {
    eventType: "build",
    overview: "Students will construct a rubber-powered helicopter for maximum flight time.",
  },
  Hovercraft: {
    eventType: "build",
  ...
  "Mission Possible": {
    eventType: "build",
    overview: "Students will build a Rube Goldberg-like device to complete a task.",
  },
  "Robot Tour": {
    eventType: "build",
  ...
  Scrambler: {
    eventType: "build",
    overview: "Students will build a vehicle to transport an egg without breaking it.",
  },
};
...
function baseEvent(name: string, division: Array<"B" | "C">): DocsEvent {
  ...
  const base: DocsEvent = {
    ...
    links: [
      ...
      { label: "2026 Event Table (SOINC)", url: "https://www.soinc.org/events/2025-event-table" },
    ],
  };
...
for (const evt of [...eventsB, ...eventsC]) {
  ...
  if (slugToEvent[slug]) {
    const merged: DocsEvent = {
      ...slugToEvent[slug],
      division: Array.from(new Set([...slugToEvent[slug].division, ...evt.division])) as Array<
        "B" | "C"
      >,
    };
