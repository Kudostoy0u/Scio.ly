        ...
        >
          ...
          <div className="mb-12">
            ...
            <p className={`mb-4 ${
              ...
              For <code className={`px-2 py-1 rounded ${
                darkMode ? 'bg-gray-700 text-blue-400' : 'bg-gray-100 text-blue-600'
              }`}>/mcq</code> or <code className={`px-2 py-1 rounded ${
                darkMode ? 'bg-gray-700 text-blue-400' : 'bg-gray-100 text-blue-600'
              }`}>/frq</code>, only choose divisions or subtopics that have green cells (or else the bot will choose randomly for you).
            </p>
              ...
              <table className={`w-full border-collapse border text-xs ${
                ...
                <thead>
                  <tr className={`${
                    ...
                    <th className="border px-2 py-2 text-left font-semibold">Dynamic Planet - Oceanography</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className={`${
                  ...
                  {/* Subtopic rows */}
                  {[
                    ['Hormones', 'Brain', 'Eyes', 'Solar System', 'Stoichiometry', 'Circuits', 'Genetics', 'Epidemiology', 'Ocean Circulation'],
                    ['Glands', 'Spinal Cord', 'Ears', 'Stars', 'Periodicity', 'Sensors', 'DNA', 'Pathogens', 'Marine Life'],
                    ['Regulation', 'Nerves', 'Nose', 'Galaxies', 'Equilibrium', 'Calibration', 'Proteins', 'Prevention', 'Chemistry'],
                    ['Feedback', 'Reflexes', 'Tongue', 'Cosmology', 'Redox Reactions', 'Design', 'Evolution', 'Outbreak Investigation', 'Geology'],
                    ['Development', 'Neurotransmitters', 'Skin', 'Instruments', 
                      <div key="chemistry-dropdown" className="relative">
                        <details className="cursor-pointer">
                          ...
                          <div className={`absolute top-full left-0 z-10 mt-1 p-2 rounded border shadow-lg ${
                      ...
                      'Troubleshooting', 'Population Genetics', 'Statistics', 'Climate']
                  ].map((row, index) => (
              ...
              <table className={`w-full border-collapse border text-xs ${
                ...
                <thead>
                  <tr className={`${
                    ...
                    <th className="border px-2 py-2 text-left font-semibold">Water Quality - Freshwater</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className={`${
                  ...
                  {/* Subtopic rows */}
                  {[
                    ['Insect Anatomy', 'Evidence Analysis', 'Genetics', 'Weather Systems', 'Estimation', 'Toxicology', 'Igneous', 'Planets', 'PH'],
                    ['Life Cycles', 'Fingerprints', 'DNA', 'Clouds', 'Orders of Magnitude', 'Pharmacology', 'Sedimentary', 'Moons', 'Dissolved Oxygen'],
                    ['Behavior', 'DNA', 'Proteins', 'Percipitation', 'Problem Solving', 'Dosage', 'Metamorphic', 'Asteroids', 'Nutrients'],
                    ['Classification', 'Toxicology', 'Evolution', 'Temperature', 'Scientific Reasoning', 'Symptoms', 'Mineral Properties', 'Comets', 'Pollutants'],
                    ['Ecology', 'Crime Scene', 'Population Genetics', 'Pressure', 'Calculations', 'Antidotes', 'Crystal Systems', 'Galaxies', 'Testing']
                  ].map((row, index) => (
                    <tr key={index} className={`${
                      darkMode ? 'border-gray-600 hover:bg-gray-700' : 'border-gray-300 hover:bg-gray-50'
                    }`}>
