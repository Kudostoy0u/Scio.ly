...
export default function SystemSection() {
      ...
      <div className="space-y-6">
        ...
        >
          <div className="space-y-4">
            <div>
              <h4
                className={`text-sm md:text-base font-semibold mb-3 ${darkMode ? "text-gray-100" : "text-gray-900"}`}
              >
                Request Body Schema
              </h4>
              <div className="space-y-2">
                <Param name="name" type="string" required={true} description="Contact name" />
                <Param name="email" type="string" required={true} description="Contact email" />
                <Param
                  name="topic"
                  type="string"
                  description="Message topic (default: 'general')"
                />
                <Param name="message" type="string" required={true} description="Message content" />
              </div>
            </div>
  ...
  "message": "Message sent successfully!"
            ...
            <InfoBox>
              <strong>Rate Limiting:</strong> 10 requests per minute per IP address.
              <br />
              <strong>Integration:</strong> Messages are sent to Discord webhook for team
              notification.
            </InfoBox>
          </div>
        </Endpoint>
