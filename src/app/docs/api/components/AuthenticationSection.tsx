      ...
      <div className="space-y-6">
        <div>
          ...
          <p className={`mb-4 ${darkMode ? "text-gray-400" : "text-gray-600"}`}>
            Most API endpoints require authentication using API keys. API keys are provided on
            request - please contact us at team.scio.ly@gmail.com to request an API key.
          </p>
...
Authorization: Bearer your-api-key-here`}
                ...
                <div>
                  ...
                  <WarningBox>
                    <strong>Security Warning:</strong> Query parameters may be logged in server
                    logs, browser history, and proxy logs. Use headers when possible.
                  </WarningBox>
