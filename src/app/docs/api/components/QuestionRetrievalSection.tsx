				...
				>
					<div className="space-y-4">
						<div>
							...
							<div className="space-y-2">
								...
								<Param
									name="division"
									type="string"
									description="Filter by division (B, C, B/C)"
								/>
								<Param
									name="tournament"
									type="string"
								...
								<Param
									name="subtopic"
									type="string"
									description="Filter by single subtopic"
								/>
								<Param
									name="subtopics"
									type="string"
						...
						<Example title="Example Request" variant="request">
							GET
							/api/questions?event=Chemistry%20Lab&division=C&question_type=mcq&limit=10
						</Example>
  ...
  "data": [
    {
      ...
      "base52": "ABC12"
						...
						<InfoBox>
							<strong>Performance Notes:</strong> Uses indexed random selection
							with fallback to ORDER BY RANDOM(). Two-phase selection ensures
							even distribution across the dataset.
						</InfoBox>
					</div>
				</Endpoint>
  ...
  "data": [
    ...
    },
    {
      ...
      "base52": "DEF34"
						...
						<InfoBox>
							<strong>Features:</strong> Automatically searches both regular
							questions and ID questions tables. Returns questions in the same
							order as requested IDs. ID questions include imageData field.
						</InfoBox>
					</div>
				</Endpoint>
				...
				>
					<div className="space-y-4">
						...
						<Example title="Example Request" variant="request">
							GET
							/api/id-questions?event=Rocks%20and%20Minerals&division=C&limit=10
						</Example>
  ...
  "data": [
    {
      ...
      "updated_at": "2024-01-15T10:30:00Z"
						...
						<InfoBox>
							<strong>Features:</strong> Uses the same two-phase random
							selection as regular questions. Each question includes an images
							array with CDN URLs for identification.
						</InfoBox>
					</div>
				</Endpoint>
			</div>
