...
export const createUpdateActions = (
  ...
  const updateRoster = (teamSlug: string, subteamId: string, roster: RosterData) => {
  ...
  const updateMembers = (teamSlug: string, subteamId: string, members: TeamMember[]) => {
  ...
  const addStreamPost = (teamSlug: string, subteamId: string, post: StreamPost) => {
  ...
  const updateSubteam = (teamSlug: string, subteamId: string, updates: Partial<Subteam>) => {
    set((state) => ({
      subteams: {
        ...state.subteams,
