...
describe("RosterNotificationService", () => {
	...
	describe("getRosterNotifications", () => {
		it("should fetch roster notifications for a user", async () => {
			...
			const result = await RosterNotificationService.getRosterNotifications(
				userId,
				10,
			);
		...
		it("should return empty array on error", async () => {
			...
			const result =
				await RosterNotificationService.getRosterNotifications("user-123");
	...
	describe("markRosterNotificationsAsRead", () => {
		it("should mark specific notifications as read", async () => {
			...
			await RosterNotificationService.markRosterNotificationsAsRead(
				userId,
				notificationIds,
			);
