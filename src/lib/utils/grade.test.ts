...
describe('getLetterGradeFromPercentage', () => {
  it('returns N/A for invalid inputs', () => {
    expect(getLetterGradeFromPercentage(NaN as any)).toBe('N/A');
...
describe('percentageFromEarnedAndTotal', () => {
  it('handles invalid parameters', () => {
    expect(percentageFromEarnedAndTotal(NaN as any, 10)).toBe(0);
    expect(percentageFromEarnedAndTotal(5, NaN as any)).toBe(0);
