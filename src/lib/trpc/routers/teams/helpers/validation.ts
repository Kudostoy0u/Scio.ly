...
export async function checkTeamGroupAccessOrThrow(userId: string, groupId: string) {
...
export async function validateSubteamBelongsToGroup(subteamId: string, groupId: string) {
...
export function buildSubteamWhereCondition(groupId: string, subteamId?: string) {
...
export async function ensureUserDisplayName(userId: string, userEmail?: string) {
  try {
