...
export const TeamSlugSchema = z
  ...
  .regex(/^[a-z0-9-]+$/, "Team slug must contain only lowercase letters, numbers, and hyphens");
...
export const PostCalendarEventRequestSchema = z.object({
  ...
  endTime: z.string().datetime("End time must be a valid ISO datetime").nullable().optional(),
...
export const PutCalendarEventRequestSchema = PostCalendarEventRequestSchema.partial().extend({
  id: UUIDSchema,
});
 ...
 */
export function formatValidationError(error: z.ZodError): { error: string; details: string[] } {
...
export type StreamPostWithComments = z.infer<typeof StreamPostWithCommentsSchema>;
...
export type PostStreamCommentRequest = z.infer<typeof PostStreamCommentRequestSchema>;
...
export type PostCalendarEventRequest = z.infer<typeof PostCalendarEventRequestSchema>;
export type PutCalendarEventRequest = z.infer<typeof PutCalendarEventRequestSchema>;
