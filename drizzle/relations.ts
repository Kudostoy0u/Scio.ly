...
export const relations = defineRelations(schema, (r) => ({
	...
	newTeamUnits: {
		...
		newTeamAssignmentsViaNewTeamAssignmentRoster: r.many.newTeamAssignments({
			alias: "newTeamAssignments_id_newTeamUnits_id_via_newTeamAssignmentRoster"
		}),
	...
	newTeamAssignments: {
		...
		newTeamUnits: r.many.newTeamUnits({
			from: r.newTeamAssignments.id.through(r.newTeamAssignmentRoster.assignmentId),
	...
	newTeamAssignmentQuestions: {
		newTeamAssignmentSubmissions: r.many.newTeamAssignmentSubmissions({
			from: r.newTeamAssignmentQuestions.id.through(r.newTeamAssignmentQuestionResponses.questionId),
			to: r.newTeamAssignmentSubmissions.id.through(r.newTeamAssignmentQuestionResponses.submissionId)
		}),
		newTeamAssignment: r.one.newTeamAssignments({
